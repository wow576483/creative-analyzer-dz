...
window.AUTOSCAN_CONFIG = {
  ...
  products: [
    {
      id: "battery-cut-off",
      name: "قاطع البطارية الذكي — AnFeiDiPei (مفتاح كهرباء السيارة)",
      shortDesc: "إذا بطاريتك تفرغ وحدها… هذا الحل اللي ما يقولوهالكش 😳 — قاطع بطارية احترافي يحمي سيارتك ويوفّر مصاريف بدّلت بطارية.",
      price: 2900,
      oldPrice: 4500,
      image: "assets/img/battery-switch-1.jpg",
      badges: ["🔥 وفّر 1600 دج", "🛡️ حماية كاملة", "🧲 نحاس فاخر"],
      bullets: [
        "🔴 تشغيل / إيقاف سريع (On/Off) — تقطع الكهرباء كاملة بكبسة وحدة",
        "🔧 تركيب سهل في دقائق — بدون خبرة، بدون ميكانيكي",
        "🛡️ حماية كاملة للسيارة من تفريغ البطارية ومن السرقة",
        "⚡ مناسب لمعظم السيارات (12V) — حجم متوافق",
        "🧲 مصنوع من النحاس عالي الجودة — يدوم سنين",
      ],
    },
    {
      id: "obd2-pro",
